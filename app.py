...
class AgenteHigieneAnimal:
    ...
    def __init__(self):
        self.frases_vigentes = [
            "Los productos cosméticos destinados a animales no se consideran cosméticos bajo el Reglamento (CE) 1223/2009, aplicable solo a personas.",
            "Con la publicación de la Ley 1/2025 se eliminó la obligatoriedad de registro de los productos de higiene, cuidado y manejo de los animales (HCM) y del material y utillaje zoosanitario (MUZ).",
            "Estos productos deben cumplir con el Reglamento (CE) 1272/2008 (CLP), el Reglamento (CE) 1907/2006 (REACH) y el Reglamento (UE) 2023/988 sobre seguridad general de los productos.",
            "Si el producto reivindica una función biocida, aplica el Reglamento (UE) 528/2012, con trámites ante la autoridad competente correspondiente."
        ]
